...
# Configuration
layout: post
permalink: blog/sample # generate random number?

# Content
title: SwipeX
date: 2021-05-16 13:59:10 +0800
post-type: project
author: Li Han
description: NTU News Media Lab sample readme
tags: [Mobile App]
...
##### Front-end React app
1. To navigate to the front-end React project: `>>> cd swipex` shpee
1. To install Nodejs dependencies:
```>>> npm install```
1. To launch React app:
```>>> npm start```
...
<br> ```pip install Django-cors-headers```
<br>
```
dfd
